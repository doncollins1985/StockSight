...
def create_sequences_with_sentiment(
    ...
    Parameters:
        price_file (str): Path to the merged CSV file.
        output_file (str): Path where the sequences will be saved (.npz).
        feature_columns (list): List of feature column names.
        window_size (int): The number of timesteps per sequence.
        scaler_path_X (str): Path to save the scaler for features.
        scaler_path_y (str): Path to save the scaler for targets.
    """
    ...
    # Ensure the scaler directories exist
